...
public class GenAccessToken {
    ...
    public static void main(String[] args) {
        String access_token = genAccessToken("SKfbWu6u2A8CfUckQZDNlbLC9TKvTa5oU",
                "TzNCaAlJac3NWUVROd2ZPNE9PTEc1Mk9iZVI0QW5NQ0E=", 3600);

        System.out.println("access_token" + access_token);
    }

    public static String genAccessToken(String keySid, String keySecret, int expireInSecond) {
        try {
