...
public class I18NConfig implements WebMvcConfigurer{
	...
	@Bean("localeResolver")
	public LocaleResolver getLacaleResolver() {
	...
	@Override
	public void addInterceptors(InterceptorRegistry regitry) {
		LocaleChangeInterceptor lci = new LocaleChangeInterceptor();
		lci.setParamName("lang");
		regitry.addInterceptor(lci).addPathPatterns("/**").excludePathPatterns("/images/**");
	}
}
